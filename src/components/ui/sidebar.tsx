...
import { SidebarContext, useSidebar } from "@/context/sidebar-provider"
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className={cn("flex h-full w-full flex-col bg-sidebar group-data-[state=expanded]:w-[16rem] overflow-hidden transition-all duration-300",
             "group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
            )}
          >
           <div className={cn("absolute left-0 top-0 h-full transition-all duration-300", state === 'expanded' ? 'w-[16rem]' : 'w-[3rem]')}>
            {children}
           </div>
          </div>
        </div>
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex h-full flex-1 flex-col bg-background transition-all duration-300",
